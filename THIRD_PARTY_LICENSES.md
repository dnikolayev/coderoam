...
- Rows marked `review` could not be confidently classified from the local module
  cache with a simple detector. Verify them with a release-time license scanner
...
| `github.com/mdp/qrterminal/v3` | `v3.2.1` | review | `LICENSE` |
...
| `github.com/beeper/argo-go` | `v1.1.2` | review | `LICENSE` |
| `github.com/coder/websocket` | `v1.8.14` | review | `LICENSE.txt` |
| `github.com/coreos/go-systemd/v22` | `v22.7.0` | review | `-` |
| `github.com/cpuguy83/go-md2man/v2` | `v2.0.6` | review | `-` |
| `github.com/davecgh/go-spew` | `v1.1.1` | ISC-like | `LICENSE` |
| `github.com/dustin/go-humanize` | `v1.0.1` | review | `LICENSE` |
| `github.com/elliotchance/orderedmap/v3` | `v3.1.0` | MIT | `LICENSE` |
| `github.com/golang/protobuf` | `v1.5.0` | review | `-` |
...
| `github.com/hashicorp/golang-lru/v2` | `v2.0.7` | review | `LICENSE` |
...
| `github.com/pkg/errors` | `v0.9.1` | review | `-` |
...
| `github.com/rs/xid` | `v1.6.0` | review | `-` |
| `github.com/rs/zerolog` | `v1.35.1` | MIT | `LICENSE` |
| `github.com/russross/blackfriday/v2` | `v2.1.0` | review | `-` |
| `github.com/sergi/go-diff` | `v1.3.1` | review | `LICENSE` |
| `github.com/skip2/go-qrcode` | `v0.0.0-20200617195104-da1b6568686e` | review | `LICENSE` |
| `github.com/spf13/cobra` | `v1.10.2` | Apache-2.0 | `LICENSE.txt` |
| `github.com/spf13/pflag` | `v1.0.9` | BSD-style | `LICENSE` |
| `github.com/stretchr/testify` | `v1.11.1` | MIT | `LICENSE` |
| `github.com/vektah/gqlparser/v2` | `v2.5.27` | review | `LICENSE` |
| `go.mau.fi/libsignal` | `v0.2.2` | review | `LICENSE` |
| `go.mau.fi/util` | `v0.9.9` | MPL-2.0 | `LICENSE` |
| `go.mau.fi/whatsmeow` | `v0.0.0-20260604205742-c6a4b703e48f` | MPL-2.0 | `LICENSE` |
| `go.yaml.in/yaml/v3` | `v3.0.4` | review | `-` |
...
| `golang.org/x/tools/go/expect` | `v0.1.1-deprecated` | review | `-` |
| `golang.org/x/tools/go/packages/packagestest` | `v0.1.1-deprecated` | review | `-` |
| `google.golang.org/protobuf` | `v1.36.11` | BSD-style | `LICENSE` |
| `gopkg.in/check.v1` | `v0.0.0-20161208181325-20d25e280405` | review | `-` |
